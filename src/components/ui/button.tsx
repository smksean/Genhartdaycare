  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-base font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Brand variants for Genhart Daycare
        cta: "bg-brand-red text-primary-foreground hover:bg-brand-red/90 shadow-lg hover:shadow-xl hover:-translate-y-0.5",
        success: "bg-brand-green text-primary-foreground hover:bg-brand-green/90 shadow-soft",
        warm: "bg-brand-orange text-primary-foreground hover:bg-brand-orange/90 shadow-soft",
        playful: "bg-brand-yellow text-foreground hover:bg-brand-yellow/90 shadow-soft",
      },
      size: {
